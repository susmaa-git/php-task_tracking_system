...
if(isset($_POST['create'])){
  ...
  $color = $_POST['color'];
  if($board_id!= "" && $task_id != "" && $label_title != "" && $label_description != "" && $color!= ""){
    $insert = "INSERT INTO labels(board_id,task_id,label_title,label_description,color)VALUES('$board_id','$task_id','$label_title','$label_description','$color')";
      $get_insert = mysqli_query($conn, $insert);
      if($get_insert){
        ?>   
         <div class="alert alert-dismissible fade show" role = "alert">
          <strong>Ta sk is added successful</strong>
       ...
       <div class="alert alert-dismissible fade show">
        <strong>Ta addition failed</strong>
        <button type="button" class="btn-close" aria-label="close" data-bs-dismiss="alert"></button>
       </div>
        <?php
            ...
            <div class="card-body">
              ...
              <form class="w-50 mx-auto" method="POST" action = "#" enctype="multipart/form-data">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="label_title" name="label_title"    aria-describedby="emailHelp">
                  </div>
                  <div class="mb-3">
                    <label for="label_description" class="form-label">label_description:</label>
                    <input type="text" class="form-control" id="label_description" name = "label_description" aria-describedby="emailHelp">
                  </div>
                  <div class="mb-3">
