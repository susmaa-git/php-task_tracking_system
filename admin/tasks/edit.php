...
if(isset($_POST['create'])){
  ...
  if( $task_title != "" && $task_description != ""){
     $insert = "UPDATE taskboard SET task_title = '$task_title', task_description = '$task_description' WHERE id = $id";
      $get_insert = mysqli_query($conn, $insert);
      if($get_insert){
        ?>   
         <div class="alert alert-dismissible fade show" role = "alert">
          <strong>Task is added successful</strong>
       ...
       <div class="alert alert-dismissible fade show">
        <strong>Task addition failed</strong>
        <button type="button" class="btn-close" aria-label="close" data-bs-dismiss="alert"></button>
       </div>
        <?php
            ...
            <div class="card-body">
              ...
              <form class="w-50 mx-auto" method="POST" action = "#" enctype="multipart/form-data">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="task_title" name = "task_title" value = "<?php echo $data['task_title'];?>" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="task_description" class="form-label">task_description:</label>
                    <input type="text" class="form-control" id="task_description" name = "task_description"  value = "<?php echo $data['task_description'] ?>" aria-describedby="emailHelp">
                </div>
                  <div class="mb-3">
